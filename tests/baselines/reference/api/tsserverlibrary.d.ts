...
declare namespace ts {
    ...
    type GreaterThanToken = Token<SyntaxKind.GreaterThanToken>;
    type GreaterThanEqualsToken = Token<SyntaxKind.GreaterThanEqualsToken>;
    type LessThanToken = Token<SyntaxKind.LessThanToken>;
    type LessThanEqualsToken = Token<SyntaxKind.LessThanEqualsToken>;
    ...
    interface HalfRangeTypeNode extends TypeNode {
    ...
    interface RangeType extends Type {
...
declare namespace ts {
    ...
    function isHalfRangeTypeNode(node: Node): node is HalfRangeTypeNode;
